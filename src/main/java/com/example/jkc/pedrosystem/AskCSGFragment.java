 ...
 * {@link AskCSGFragment.OnFragmentInteractionListener} interface
...
public class AskCSGFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        viewPager = (ViewPager) view.findViewById(R.id.viewpagerAskCSG);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new AnswersFragment(), "Answers");
